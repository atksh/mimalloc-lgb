...
int main()
{
    std::vector<compute::platform, mi_stl_allocator<compute::platform>> platforms = compute::system::platforms();
    ...
    for (size_t i = 0; i < platforms.size(); i++)
    {
        ...
        std::vector<compute::device, mi_stl_allocator<compute::device>> devices = platform.devices();
