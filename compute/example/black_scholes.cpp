...
int main()
{
    ...
    std::vector<float, mi_stl_allocator<float>> stock_price_data(N);
    std::vector<float, mi_stl_allocator<float>> option_strike_data(N);
    std::vector<float, mi_stl_allocator<float>> option_years_data(N);
