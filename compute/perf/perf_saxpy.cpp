...
int main(int argc, char *argv[])
{
    ...
    options.add_options()("help", "show usage instructions")("size", po::value<size_t>()->default_value(8192), "input size")("trials", po::value<size_t>()->default_value(3), "number of trials to run")("tune", "run tuning procedure")("alpha", po::value<double>()->default_value(2.5), "saxpy alpha value");
    ...
    std::vector<float, mi_stl_allocator<float>> host_x(size);
    std::vector<float, mi_stl_allocator<float>> host_y(size);
