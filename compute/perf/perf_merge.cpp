...
int main(int argc, char *argv[])
{
    ...
    std::vector<int, mi_stl_allocator<int>> v1 = generate_random_vector<int>(std::floor(PERF_N / 2.0));
    std::vector<int, mi_stl_allocator<int>> v2 = generate_random_vector<int>(std::ceil(PERF_N / 2.0));
    std::vector<int, mi_stl_allocator<int>> v3(PERF_N);
    ...
    std::vector<int, mi_stl_allocator<int>> check_v3(PERF_N);
