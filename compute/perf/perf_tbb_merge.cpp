...
struct ParallelMergeRange
{
    ...
    ParallelMergeRange(Iterator begin1_, Iterator end1_,
                       ...
                       Iterator out_) : begin1(begin1_), end1(end1_),
...
int main(int argc, char *argv[])
{
    ...
    std::vector<int, mi_stl_allocator<int>> v1 = generate_random_vector<int>(PERF_N / 2);
    std::vector<int, mi_stl_allocator<int>> v2 = generate_random_vector<int>(PERF_N / 2);
