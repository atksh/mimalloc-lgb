...
int main(int argc, char *argv[])
{
    ...
    boost::compute::vector<int>::iterator device_max_iter = device_vector.begin();
    ...
    std::vector<int, mi_stl_allocator<int>>::iterator host_max_iter = std::max_element(host_vector.begin(), host_vector.end());
