...
int main(int argc, char *argv[])
{
    ...
    std::vector<int, mi_stl_allocator<int>> host_vec1 = generate_random_vector<int>(std::floor(PERF_N / 2.0));
    std::vector<int, mi_stl_allocator<int>> host_vec2 = generate_random_vector<int>(std::ceil(PERF_N / 2.0));
    // sort them
