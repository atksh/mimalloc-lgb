...
int main(int argc, char *argv[])
{
    ...
    // create host vectors
    std::vector<int, mi_stl_allocator<int>> host_x = generate_random_vector<int>(PERF_N);
    std::vector<int, mi_stl_allocator<int>> host_y = generate_random_vector<int>(PERF_N);
