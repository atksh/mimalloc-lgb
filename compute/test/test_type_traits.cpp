...
BOOST_AUTO_TEST_CASE(is_contiguous_iterator)
{
    ...
    BOOST_STATIC_ASSERT(is_contiguous_iterator<std::vector<int, mi_stl_allocator<int>>::iterator>::value == true);
    BOOST_STATIC_ASSERT(is_contiguous_iterator<std::vector<int, mi_stl_allocator<int>>::const_iterator>::value == true);
    ...
    BOOST_STATIC_ASSERT(is_contiguous_iterator<std::back_insert_iterator<std::vector<int, mi_stl_allocator<int>>>>::value == false);
}
...
BOOST_AUTO_TEST_CASE(is_device_iterator)
{
    ...
    BOOST_STATIC_ASSERT(is_device_iterator<std::vector<int, mi_stl_allocator<int>>::iterator>::value == false);
    BOOST_STATIC_ASSERT(is_device_iterator<const std::vector<int, mi_stl_allocator<int>>::iterator>::value == false);
}
