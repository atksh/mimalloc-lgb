...
BOOST_AUTO_TEST_CASE(sort_mid_vector_int)
{
    ...
    const int_ size = 748;
    std::vector<int_, mi_stl_allocator<int_>> data(size);
...
BOOST_AUTO_TEST_CASE(sort_mid_vector_ulong)
{
    ...
    std::vector<ulong_, mi_stl_allocator<ulong_>> data(size);
...
BOOST_AUTO_TEST_CASE(sort_mid_vector_float)
{
    ...
    const int size = 513;
    std::vector<float_, mi_stl_allocator<float_>> data(size);
...
BOOST_AUTO_TEST_CASE(sort_mid_vector_double)
{
    ...
    const int size = 1023;
    std::vector<double_, mi_stl_allocator<double_>> data(size);
    for (int i = 0; i < size; i++)
    {
...
BOOST_AUTO_TEST_CASE(sort_mid_vector_int2)
{
    ...
    const int_ size = 1024;
    std::vector<int2_, mi_stl_allocator<int2_>> data(size);
    for (int_ i = 0; i < size; i++)
    {
...
BOOST_AUTO_TEST_CASE(sort_mid_vector_long8)
{
    ...
    std::vector<long8_, mi_stl_allocator<long8_>> data(size);
