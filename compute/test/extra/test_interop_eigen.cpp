...
{
    std::vector<Eigen::Vector4f, mi_stl_allocator<Eigen::Vector4f>> host_vectors;
    std::vector<Eigen::Matrix4f, mi_stl_allocator<Eigen::Matrix4f>> host_matrices;
    ...
    std::vector<Eigen::Vector4f, mi_stl_allocator<Eigen::Vector4f>> host_results(4);
