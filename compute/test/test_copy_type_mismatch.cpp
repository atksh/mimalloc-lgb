...
BOOST_AUTO_TEST_CASE(is_same_ignore_const)
{
    BOOST_STATIC_ASSERT((
        boost::compute::detail::is_same_value_type<
            std::vector<int, mi_stl_allocator<int>>::iterator,
            compute::buffer_iterator<int>>::value));
    BOOST_STATIC_ASSERT((
        boost::compute::detail::is_same_value_type<
            std::vector<int, mi_stl_allocator<int>>::const_iterator,
            compute::buffer_iterator<int>>::value));
    BOOST_STATIC_ASSERT((
        boost::compute::detail::is_same_value_type<
            std::vector<int, mi_stl_allocator<int>>::iterator,
            compute::buffer_iterator<const int>>::value));
    BOOST_STATIC_ASSERT((
        boost::compute::detail::is_same_value_type<
            std::vector<int, mi_stl_allocator<int>>::const_iterator,
            compute::buffer_iterator<const int>>::value));
...
BOOST_AUTO_TEST_CASE(copy_to_host_float_to_int)
{
    ...
    std::vector<int_, mi_stl_allocator<int_>> host_vector(4);
...
BOOST_AUTO_TEST_CASE(copy_async_to_host_float_to_int)
{
    ...
    float_ data[] = {6.1f, -10.2f, 19.3f, 25.4f};
    bc::vector<float_> device_vector(data, data + 4, queue);
    std::vector<int_, mi_stl_allocator<int_>> host_vector(device_vector.size());
...
BOOST_AUTO_TEST_CASE(copy_async_to_host_float_to_int_empty)
{
    ...
    float_ data[] = {6.1f, -10.2f, 19.3f, 25.4f};
    bc::vector<float_> device_vector(data, data + 4, queue);
    std::vector<int_, mi_stl_allocator<int_>> host_vector(device_vector.size(), int_(1));
...
BOOST_AUTO_TEST_CASE(copy_to_host_svm_float_to_int_map)
{
    ...
    std::vector<int_, mi_stl_allocator<int_>> host_vector(4, 0);
    compute::svm_ptr<float_> ptr = compute::svm_alloc<float_>(context, 4);
