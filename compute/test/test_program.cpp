...
{
    std::vector<std::string, mi_stl_allocator<std::string>> sources;
...
BOOST_AUTO_TEST_CASE(program_source_no_file)
{
    ...
    BOOST_CHECK_THROW(boost::compute::program program =
                          boost::compute::program::create_with_source_file(std::string(), context),
...
BOOST_AUTO_TEST_CASE(create_with_binary)
{
    ...
    // get binary
    std::vector<unsigned char, mi_stl_allocator<unsigned char>> binary = source_program.binary();
...
BOOST_AUTO_TEST_CASE(get_program_il_binary)
{
    ...
    std::vector<unsigned char, mi_stl_allocator<unsigned char>> il_binary;
...
BOOST_AUTO_TEST_CASE(compile_and_link)
{
    ...
    // link the programs
    std::vector<compute::program, mi_stl_allocator<compute::program>> programs;
...
BOOST_AUTO_TEST_CASE(compile_and_link_with_headers)
{
    ...
    std::vector<std::pair<std::string, compute::program>, mi_stl_allocator<std::pair<std::string, compute::program>>> header_programs;
