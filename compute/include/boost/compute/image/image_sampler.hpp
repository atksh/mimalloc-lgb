    ...
    namespace compute
    {
        ...
        public:
                          ...
                          cl_filter_mode filter_mode)
            {
                ...
                std::vector<cl_sampler_properties, mi_stl_allocator<cl_sampler_properties>> sampler_properties;
        ...
        BOOST_COMPUTE_DETAIL_DEFINE_GET_INFO_SPECIALIZATIONS(image_sampler,
                                                             ((cl_uint, CL_SAMPLER_REFERENCE_COUNT))((cl_context, CL_SAMPLER_CONTEXT))((cl_addressing_mode, CL_SAMPLER_ADDRESSING_MODE))((cl_filter_mode, CL_SAMPLER_FILTER_MODE))((bool, CL_SAMPLER_NORMALIZED_COORDS)))
