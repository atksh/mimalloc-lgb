...
namespace boost
{
    namespace compute
    {
        ...
        public:
            ...
            static std::vector<image_format, mi_stl_allocator<image_format>>
...
#else
                return std::vector<image_format, mi_stl_allocator<image_format>>();
#endif
            }
        ...
        BOOST_COMPUTE_DETAIL_DEFINE_GET_INFO_SPECIALIZATIONS(image1d,
                                                             ((cl_image_format, CL_IMAGE_FORMAT))((size_t, CL_IMAGE_ELEMENT_SIZE))((size_t, CL_IMAGE_ROW_PITCH))((size_t, CL_IMAGE_SLICE_PITCH))((size_t, CL_IMAGE_WIDTH))((size_t, CL_IMAGE_HEIGHT))((size_t, CL_IMAGE_DEPTH)))
