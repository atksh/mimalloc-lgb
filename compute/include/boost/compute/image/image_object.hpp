    ...
    namespace compute
    {
        ...
        public:
                                  ...
                                  cl_mem_flags flags = read_write)
            {
                ...
                std::vector<cl_image_format, mi_stl_allocator<cl_image_format>> cl_formats(count);
                clGetSupportedImageFormats(context, flags, type, count, &cl_formats[0], 0);

                std::vector<image_format, mi_stl_allocator<image_format>> formats;
            ...
            static bool is_supported_format(const image_format &format,
                                            ...
                                            cl_mem_flags flags = read_write)
            {
                const std::vector<image_format, mi_stl_allocator<image_format>> formats =
