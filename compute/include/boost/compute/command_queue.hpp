    ...
    namespace compute
    {
        ...
        public:
                          ...
                          cl_command_queue_properties properties = 0)
            {
                ...
                {
                    std::vector<cl_queue_properties, mi_stl_allocator<cl_queue_properties>> queue_properties;
                    if (properties)
                    {
...
// just forward to the equivalent clEnqueueNDRangeKernel() call.
            ...
            event enqueue_svm_migrate_memory(const std::vector<const void *, mi_stl_allocator<const void *>> &svm_ptrs,
                                             const std::vector<size_t, mi_stl_allocator<size_t>> &sizes,
        ...
        BOOST_COMPUTE_DETAIL_DEFINE_GET_INFO_SPECIALIZATIONS(command_queue,
                                                             ((cl_context, CL_QUEUE_CONTEXT))((cl_device_id, CL_QUEUE_DEVICE))((uint_, CL_QUEUE_REFERENCE_COUNT))((cl_command_queue_properties, CL_QUEUE_PROPERTIES)))
