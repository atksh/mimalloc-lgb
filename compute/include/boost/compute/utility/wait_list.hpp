...
namespace boost
{
    namespace compute
    {
        ...
        {
        public:
            typedef std::vector<event, mi_stl_allocator<event>>::iterator iterator;
            typedef std::vector<event, mi_stl_allocator<event>>::const_iterator const_iterator;
        ...
        private:
            std::vector<event, mi_stl_allocator<event>> m_events;
        };
