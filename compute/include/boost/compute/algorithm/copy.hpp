...
namespace boost
{
    namespace compute
    {
        namespace detail
        {
            ...
            struct can_copy_with_copy_buffer : mpl::and_<
                                                   mpl::or_<
                                                       boost::is_same<
                                                           InputIterator,
            ...
            struct is_same_value_type : boost::is_same<
                                            typename boost::remove_cv<
                                                typename std::iterator_traits<HostIterator>::value_type>::type,
                                            typename boost::remove_cv<
                                                typename DeviceIterator::value_type>::type>::type
            {
            };

            // meta-function returning true if value_type of HostIterator is bool
            template <class HostIterator>
            struct is_bool_value_type : boost::is_same<
                                            typename boost::remove_cv<
                                                typename std::iterator_traits<HostIterator>::value_type>::type,
                                            bool>::type
            {
            ...
            dispatch_copy_async(InputIterator first,
                                ...
                                typename boost::enable_if<
                                    mpl::and_<
                                        ...
                                        is_same_value_type<InputIterator, OutputIterator>>>::type * = 0)
            {
            ...
            dispatch_copy(InputIterator first,
                          ...
                          typename boost::enable_if<
                              mpl::and_<
                                  ...
                                  is_contiguous_iterator<InputIterator>>>::type * = 0)
            {
                                  ...
                                  is_contiguous_iterator<InputIterator>>>::type * = 0)
            {
                ...
                std::string cache_key =
                    std::string("__boost_compute_copy_to_device_") + type_name<input_type>() + "_" + type_name<output_type>();
                ...
                {
                    std::vector<output_type, mi_stl_allocator<output_type>> vector(first, last);
                                      ...
                                      is_contiguous_iterator<InputIterator>>>>::type * = 0)
            {
                ...
                if (input_size_bytes < map_copy_threshold || direct_copy_threshold <= map_copy_threshold)
                {
                    return copy_to_device_map(first, last, result, queue, events);
                }
            ...
            dispatch_copy_async(InputIterator first,
                                ...
                                typename boost::enable_if<
                                    mpl::and_<
                                        ...
                                        mpl::not_<
                                            is_device_iterator<OutputIterator>>,
                                        is_same_value_type<OutputIterator, InputIterator>>>::type * = 0)
            {
                BOOST_STATIC_ASSERT_MSG(
            ...
            dispatch_copy(InputIterator first,
                          ...
                          typename boost::enable_if<
                              mpl::and_<
                                  ...
                                  mpl::not_<
                                      is_bool_value_type<OutputIterator>>>>::type * = 0)
            {
                                      ...
                                      is_bool_value_type<OutputIterator>>>>::type * = 0)
            {
                ...
                // loading parameters
                std::string cache_key =
                    std::string("__boost_compute_copy_to_host_") + type_name<input_type>() + "_" + type_name<output_type>();
                boost::shared_ptr<parameter_cache> parameters =
                    detail::parameter_cache::get_global_cache(device);
                ...
                std::vector<input_type, mi_stl_allocator<input_type>> vector(count);
                              ...
                              mpl::and_<
                                  ...
                                  mpl::not_<
                                      can_copy_with_copy_buffer<
                                          InputIterator, OutputIterator>>>>::type * = 0)
            {
        ...
        /// \c std::vector<T, mi_stl_allocator<T>>:
        /// \code
        /// std::vector<int, mi_stl_allocator<int>> host_vector = ...
