...
namespace boost
{
    namespace compute
    {
        namespace detail
        {
            ...
            // std::vector<T, mi_stl_allocator<T>>::iterator = true
            ...
            struct _is_contiguous_iterator<
                ...
                typename boost::enable_if<
                    typename boost::is_same<
                        Iterator,
                        typename std::vector<typename Iterator::value_type, mi_stl_allocator<typename Iterator::value_type>>::iterator>::type>::type> : public boost::true_type
            {
            };

            // std::vector<T, mi_stl_allocator<T>>::const_iterator = true
            template <class Iterator>
            struct _is_contiguous_iterator<
                Iterator,
                typename boost::enable_if<
                    typename boost::is_same<
                        Iterator,
                        typename std::vector<typename Iterator::value_type, mi_stl_allocator<typename Iterator::value_type>>::const_iterator>::type>::type> : public boost::true_type
            {
            };
            ...
            struct _is_contiguous_iterator<
                ...
                typename boost::enable_if<
                    typename boost::is_same<
                        Iterator,
                        typename std::valarray<typename Iterator::value_type>::iterator>::type>::type> : public boost::true_type
            {
            };
            ...
            struct _is_contiguous_iterator<
                ...
                typename boost::enable_if<
                    typename boost::is_same<
                        Iterator,
                        typename std::valarray<typename Iterator::value_type>::const_iterator>::type>::type> : public boost::true_type
            {
            };
            ...
            struct _is_contiguous_iterator<
                Iterator,
                typename boost::enable_if<
                    boost::is_pointer<Iterator>>::type> : public boost::true_type
            {
            };
            ...
            // is not a valid value_type (ex. std::vector<void, mi_stl_allocator<void>>::iterator is not valid).
            ...
            struct is_contiguous_iterator<
                ...
                typename boost::enable_if<
                    typename boost::is_void<
                        typename Iterator::value_type>::type>::type> : public boost::false_type
            {
            };
