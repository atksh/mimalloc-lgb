...
*/
  ...
  public:
    ...
    explicit CrossEntropy(const std::vector<std::string, mi_stl_allocator<std::string>> &)
    {
    }
...
*/
  ...
  public:
    ...
    explicit CrossEntropyLambda(const std::vector<std::string, mi_stl_allocator<std::string>> &)
    {
    }
