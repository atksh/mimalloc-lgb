...
*/
  ...
  */
    void Init(const Config *gbdt_config, const Dataset *train_data,
              ...
              const std::vector<const Metric *, mi_stl_allocator<const Metric *>> &training_metrics) override;
  ...
  */
    void MergeFrom(const Boosting *other) override
    {
      ...
      models_ = std::vector<std::unique_ptr<Tree>, mi_stl_allocator<std::unique_ptr<Tree>>>();
    ...
    void ShuffleModels(int start_iter, int end_iter) override
    {
      ...
      auto original_models = std::move(models_);
      std::vector<int, mi_stl_allocator<int>> indices(total_iter);
  ...
  */
    void AddValidDataset(const Dataset *valid_data,
                         const std::vector<const Metric *, mi_stl_allocator<const Metric *>> &valid_metrics) override;
  ...
  */
    ...
    void RefitTree(const std::vector<std::vector<int, mi_stl_allocator<int>>, mi_stl_allocator<std::vector<int, mi_stl_allocator<int>>>> &tree_leaf_prediction) override;
  ...
  */
    std::vector<double, mi_stl_allocator<double>> GetEvalAt(int data_idx) const override;
  ...
  */
    ...
    void PredictContribByMap(const std::unordered_map<int, double> &features,
                             std::vector<std::unordered_map<int, double>, mi_stl_allocator<std::unordered_map<int, double>>> *output) const override;
  ...
  */
    std::vector<double, mi_stl_allocator<double>> FeatureImportance(int num_iteration, int importance_type) const override;
  ...
  */
    inline std::vector<std::string, mi_stl_allocator<std::string>> FeatureNames() const override { return feature_names_; }
...
#pragma omp parallel for schedule(static)
  ...
  */
    virtual std::vector<double, mi_stl_allocator<double>> EvalOneMetric(const Metric *metric, const double *score) const;
  ...
  */
    ...
    std::vector<const Metric *, mi_stl_allocator<const Metric *>> training_metrics_;
    /*! \brief Store and update validation data's scores */
    std::vector<std::unique_ptr<ScoreUpdater>, mi_stl_allocator<std::unique_ptr<ScoreUpdater>>> valid_score_updater_;
    /*! \brief Metric for validation data */
    std::vector<std::vector<const Metric *, mi_stl_allocator<const Metric *>>> valid_metrics_;
    /*! \brief Number of rounds for early stopping */
    int early_stopping_round_;
    /*! \brief Only use first metric for early stopping */
    bool es_first_metric_only_;
    /*! \brief Best iteration(s) for early stopping */
    std::vector<std::vector<int, mi_stl_allocator<int>>, mi_stl_allocator<std::vector<int, mi_stl_allocator<int>>>> best_iter_;
    /*! \brief Best score(s) for early stopping */
    std::vector<std::vector<double, mi_stl_allocator<double>>, mi_stl_allocator<std::vector<double, mi_stl_allocator<double>>>> best_score_;
    /*! \brief output message of best iteration */
    std::vector<std::vector<std::string, mi_stl_allocator<std::string>>> best_msg_;
    /*! \brief Trained models(trees) */
    std::vector<std::unique_ptr<Tree>, mi_stl_allocator<std::unique_ptr<Tree>>> models_;
    ...
    std::vector<std::string, mi_stl_allocator<std::string>> feature_infos_;
    std::unique_ptr<Dataset> tmp_subset_;
    bool is_use_subset_;
    std::vector<bool, mi_stl_allocator<bool>> class_need_train_;
    ...
    std::vector<int8_t, mi_stl_allocator<int8_t>> monotone_constraints_;
    const int bagging_rand_block_ = 1024;
    std::vector<Random, mi_stl_allocator<Random>> bagging_rands_;
