...
*/
  ...
  public:
    ...
    Tree *FitByExistingTree(const Tree *old_tree, const std::vector<int, mi_stl_allocator<int>> &leaf_pred,
...
#pragma omp parallel for schedule(static, 1)
  ...
  */
    ...
    virtual void ConstructHistograms(const std::vector<int8_t, mi_stl_allocator<int8_t>> &is_feature_used, bool use_subtract);

    virtual void FindBestSplitsFromHistograms(const std::vector<int8_t, mi_stl_allocator<int8_t>> &is_feature_used, bool use_subtract, const Tree *);
  ...
  */
    ...
    std::vector<SplitInfo, mi_stl_allocator<SplitInfo>> best_split_per_leaf_;
    /*! \brief store best split per feature for all leaves */
    std::vector<SplitInfo, mi_stl_allocator<SplitInfo>> splits_per_leaf_;
