...
/*! \brief Type of metadata, include weight and label */
  ...
  using PredictFunction =
      std::function<void(const std::vector<std::pair<int, double>, mi_stl_allocator<std::pair<int, double>>> &, double *output)>;

  using PredictSparseFunction =
      std::function<void(const std::vector<std::pair<int, double>, mi_stl_allocator<std::pair<int, double>>> &, std::vector<std::unordered_map<int, double>, mi_stl_allocator<std::unordered_map<int, double>>> *output)>;
