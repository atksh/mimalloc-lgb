...
*/
  ...
  */
    virtual void Init(
        ...
        const std::vector<const Metric *, mi_stl_allocator<const Metric *>> &training_metrics) = 0;
  ...
  */
    virtual void AddValidDataset(const Dataset *valid_data,
                                 const std::vector<const Metric *, mi_stl_allocator<const Metric *>> &valid_metrics) = 0;
  ...
  */
    virtual void RefitTree(const std::vector<std::vector<int, mi_stl_allocator<int>>, mi_stl_allocator<std::vector<int, mi_stl_allocator<int>>>> &tree_leaf_prediction) = 0;
  ...
  */
    virtual std::vector<double, mi_stl_allocator<double>> GetEvalAt(int data_idx) const = 0;
  ...
  */
    ...
    virtual void PredictContribByMap(const std::unordered_map<int, double> &features,
                                     std::vector<std::unordered_map<int, double>, mi_stl_allocator<std::unordered_map<int, double>>> *output) const = 0;
  ...
  */
    virtual std::vector<double, mi_stl_allocator<double>> FeatureImportance(int num_iteration, int importance_type) const = 0;
  ...
  */
    virtual std::vector<std::string, mi_stl_allocator<std::string>> FeatureNames() const = 0;
